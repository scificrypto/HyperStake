...
void ThreadNtpSamples(void* parg) {
    ...
    CMedianFilter<int64> vTimeOffsets(7,0);
    ...
    while (!fShutdown) {
        if (strTrustedUpstream != "localhost") {
            ...
            if (abs64(nClockOffset) < nMaxOffset) {
                ...
                int nSleepMinutes = 1 + GetRandInt(5); // Sleep for 1-10 minutes.
        ...
        int nSleepHours = 1; // + GetRandInt(2); // Sleep for 1-3 hours.
